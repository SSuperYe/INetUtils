...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NetWorks.setSubscribe(NetWorks.create(ApiService.class).testGetQuery1(""), new MySubscriber<BaseResult>(this) {
            @Override
        ...
        NetWorks.setSpecialSubscribe(NetWorks.create(ApiService.class).testGetQuery(""), new MySubscriber<BaseResult>(this) {
            @Override
            protected void onSuccess(BaseResult baseResult) {
                // TODO: 2017/12/28 0028 做一些操作
            }
